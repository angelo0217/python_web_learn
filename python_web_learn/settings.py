"""
Django settings for python_web_learn project.
...
SECRET_KEY = 'django-insecure-wtd9u3-%k(tny*&wl7=+f4^wb-aox3fqw=cycn!h3(gh5vo+tn'
...
ROOT_URLCONF = 'python_web_learn.urls'
...
WSGI_APPLICATION = 'python_web_learn.wsgi.application'
